                  ...
                  <div className="row">
                    <div className="col-md-6 text-center">
                      ...
                      <p>
                        ...
                        <span>
                          {" "}
                          {SubIndicatorInformation.generalIndicatorName}{" "}
                        </span>
                      </p>
                      <p>
                        السلعة :{" "}
                        <span>{SubIndicatorInformation.subIndicatorName}</span>
                      </p>
                      <p>
                        الوحدة : <span>{SubIndicatorInformation.unitName}</span>
                      </p>
                    </div>
                    <div className="col-md-6 text-center">
                      <p className="text-center">متوسط البيع فى المحافظات</p>
                      <h3 className="text-center">
                        {SubIndicatorInformation.avgPrice}
                      </h3>
                      <p className="text-center">
                        {SubIndicatorInformation.currencyName} /{" "}
                        {SubIndicatorInformation.unitName}
                      </p>
                      <div className="text-center my-2 MinVal GovVal">
                        <span>
                          {" "}
                          أقل سعر {SubIndicatorInformation.minPrice}{" "}
                        </span>
                        <span>{SubIndicatorInformation.minGovs}</span>
                      </div>
                      <div className="text-center my-2 MaxVal GovVal">
                        <span>
                          {" "}
                          أعلى سعر {SubIndicatorInformation.minPrice}{" "}
                        </span>
                        <span>{SubIndicatorInformation.minGovs}</span>
                      </div>
                    </div>
              ...
              <div className="card">
                ...
                >
                  ...
                  <h2 className="text-center">
                    {" "}
                    {SubIndicatorInformation.wholesaleAvg == 0
                      ? "لا يوجد"
                      : SubIndicatorInformation.wholesaleAvg}{" "}
                  </h2>
                  <p className="text-center">
                    {" "}
                    {SubIndicatorInformation.wholeSaleCurrency}{" "}
                    {SubIndicatorInformation.wholesaleAvg != 0 ? "/" : ""}{" "}
                    {SubIndicatorInformation.wholeSaleUnit}
                  </p>
            ...
            <Col md={3}>
              <div className="card">
                ...
                >
                  ...
                  <h2 className="text-center">
                    {" "}
                    {SubIndicatorInformation.portAvg == 0
                      ? "لا يوجد"
                      : SubIndicatorInformation.portAvg}{" "}
                  </h2>
                  <p className="text-center">
                    {SubIndicatorInformation.portCurrency}{" "}
                    {SubIndicatorInformation.portAvg != 0 ? "/" : ""}{" "}
                    {SubIndicatorInformation.portUnit}
                  </p>
          ...
          <Row style={{ marginTop: 20, padding: 10, margin: 0 }}>
            ...
            <Col md={9}>
              <table className="table table-bordered">
                ...
                <tbody>
                  {SubIndicatorInformation.weekDatas &&
                    SubIndicatorInformation.weekDatas.map((item, idx) => (
                      <tr>
            ...
            <Col md={12}>
              {SubIndicatorInformation.governoratesData && (
                <ResponsiveContainer width="100%" height={400}>
                  <LineChart
                    data={SubIndicatorInformation.governoratesData}
